...
def main() -> int:
    ...
    # No net changes (e.g. add + remove in same PR) — nothing to validate.
    if not changes:
        print("No net changes detected. Nothing to validate.")
        return 0
    ...
    # Otherwise validate as a new/updated plugin submission.
